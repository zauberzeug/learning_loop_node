...
def test_calculate_iou():
    detection_one = detection.ActiveLearnerDetection('dirt', 10, 0, 30, 100, None, 0.38)
    detection_two = detection.ActiveLearnerDetection('dirt', 20, 0, 30, 100, None, 0.61)
    detection_three = detection.ActiveLearnerDetection('dirt', 0, 30, 10, 10, None, 0.61)
