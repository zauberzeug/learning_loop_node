...
async def assert_upload_model(file_paths: Optional[List[str]] = None, format: str = 'mocked') -> str:
    if not file_paths:
        file_paths = ['/usr/local/lib/python3.7/site-packages/learning_loop_node/trainer/tests/test_data/file_1.txt',
                      '/usr/local/lib/python3.7/site-packages/learning_loop_node/trainer/tests/test_data/file_2.txt']
