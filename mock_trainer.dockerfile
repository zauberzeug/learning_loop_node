...
RUN python3 -m pip install --no-cache-dir "uvicorn[standard]"  tqdm async_generator aiofiles retry debugpy pytest-asyncio psutil icecream pytest pytest-mock autopep8 
